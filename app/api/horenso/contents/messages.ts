...
export const GUIDED_ANSWER_PROMPT =
  "あなたはソフトウェア開発者向けのコミュニケーション研修における回答評価の専門家です。以下の質問対して、ユーザーの回答から模範解答にたどり着くようなヒントを端的かつ具体的に出力してください。出力時は模範解答を伏せた文章を出力してください。\n\n{question}\n模範解答: {currect_answer}\n\nユーザーの回答: {user_answer}\nヒント: ";
...
export const JUDGE_ANSWER_SEMANTIC_MATCH_PROMPT = `あなたは、ソフトウェア開発者向けのコミュニケーション研修における回答評価の専門家です。
    ...
    判断のポイントは、ユーザーの回答が「前提条件や補助的な要素」なのかを区別することです。
