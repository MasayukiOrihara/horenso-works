...
export const SESSION_FLAGS_ERROR = "session flags is required";
...
export const AUTHENTICATION_REQUIRED_ERROR =
  "Vercel Deployment Protection により 401。認証 or バイパス設定が必要です。";
